    ...
    <div class="p-grid crud-demo">
        <div class="p-col-12">
            <div class="card">
                ...
                <DataTable ref="detailSalesInfo" :value="detailSalesInfo" :scrollable="true" scrollHeight="500px" dataKey="_id" editMode="cell" class="editable-cells-table" :filters="filters">
                    <template #header>
