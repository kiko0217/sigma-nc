            ...
            <div class="card">
                ...
                <DataTable ref="detailSalesInfo" :value="detailSalesInfo" 
                    ...
                    <ColumnGroup type="header">
                        <Row>
                            <Column header="Kode" headerStyle="width: 150px" :rowspan="2" />
                            <Column header="Product." headerStyle="width: 150px" :rowspan="2" />
                            <Column v-for="(col, index) of columnBulan" 
                                :key="index"
                                :header="col.header" 
                                :colspan="3" 
                                headerStyle="width: 450px"/>
                            <Column header="Total" :colspan="3" headerStyle="width: 450px"/>
                        </Row>
                        <Row>
                            <div v-for="(col, index) of columnBulan" :key="index">
                                <Column header="Sell In" headerStyle="width: 150px"/>
                                <Column header="target" headerStyle="width: 150px"/>
                                <Column header="Sales" headerStyle="width: 150px"/>
                            </div>
                            <Column header="Sell In" headerStyle="width: 150px"/>
                            <Column header="target" headerStyle="width: 150px"/>
                            <Column header="Sales" headerStyle="width: 150px"/>
                    ...
                    <Column field="Kode" headerStyle="width: 150px" :rowspan="2" />
                    <Column field="Product" headerStyle="width: 150px" :rowspan="2" />
                    <div v-for="(col, index) of columnBulan" :key="index">
                        <Column field="sellIn" headerStyle="width: 150px"/>
                        <Column field="target" headerStyle="width: 150px"/>
                        <Column field="sales" headerStyle="width: 150px"/>
                    </div>
                    <Column field="sellIn" headerStyle="width: 150px"/>
                    <Column field="target" headerStyle="width: 150px"/>
                    <Column field="sales" headerStyle="width: 150px"/>
